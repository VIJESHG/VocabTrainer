...
db.define_table("synonyms", Field("Word_Type", "string", requires=IS_NOT_EMPTY()),Field("word", "string", requires=IS_NOT_EMPTY()), Field("meaning", "text", requires = IS_NOT_EMPTY()))
